...
$\color{blue}{\text{The raw, simpler import, and extra data files can be imported into R using conventional data import methods.}}$
...
These files can be imported into R using conventional data import methods.
